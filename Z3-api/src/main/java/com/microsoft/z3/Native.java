...
public final class Native {
  ...
  protected static native String INTERNALgetParserError(long a0);
  ...
  public static String getParserError(long a0) throws Z3Exception
  {
      String res = INTERNALgetParserError(a0);
      Z3_error_code err = Z3_error_code.fromInt(INTERNALgetErrorCode(a0));
      if (err != Z3_error_code.Z3_OK)
          throw new Z3Exception(INTERNALgetErrorMsg(a0, err.toInt()));
      return res;
